    ...
    <div className="Privacypolicymain">
      ...
      <div className="container-fluid">
        <div className="container">
          <div className="row">
            <h1>INTRODUCTION</h1>
            <p>Welcome to the Khweather's privacy notice.</p>
            <br />
            <p>
              KhWeather ltd respects your privacy and is committed to protecting
              ...
              privacy rights and how to law protects you.
            </p>
            <span id="intstylleft">
              KhWeather focuses on providing convenient and easy-to-use tools
              that allow developers to work with high-quality weather data and
              other datasets. We do not collect unnecessary data and our APIs do
              not require excessive, private information in order to be fully
              functional. In other words, all data that are collected is then
              used to deliver our services.
              <br />
              <br />
              We do not collect or store any parameters from your API requests,
              such as locations/ZIP-codes/city names, units measurements, data
              format, etc. When you make API requests, we also do not collect or
              store your IP address, user agent and other API request
              parameters.
              <br />
              <br />
              To support that, below we list all types of data that are
              collected and explain why we collect them (e.g billing, technical
              support). Please do not hesitate to reach out to our team at{" "}
              <NavLink to={"/Contact"}>montukharb868@gmail.com</NavLink> if you
      ...
      <div className="container-fluid">
        <div className="container">
          <div className="row">
            ...
            <h3 id="id1">1. IMPORTANT INFORMATION AND WHO WE ARE</h3>
            <p>
              <b>PURPOSE OF THIS PRIVACY NOTICE</b>
            </p>
            <p>
              This privacy notice aims to give you information on how khWeather
              ...
              website when you sign up to our newsletter, purchase a product or
              service or take part in a competition. It is important that you
              read this privacy notice together with any other privacy notice or
              fair processing notice we may provide on specific occasions when
              we are collecting or processing personal data about you so that
            ...
            <h3>CONTROLLER</h3>
            <p>
              khWeather Ltd is the controller and responsible for your personal
              data (collectively referred to as khWeather Ltd”, “we”, “us” or
            ...
            <span>
              ...
              <NavLink to={"http://khweather.netlify.app/"}>
                khweather.ltd
              </NavLink>{" "}
              <br />
              Name of data privacy manager :<b>Montu kharb</b>
              <br />
              Email address:<b>montukharb@gmail.com</b>
              <br />
              Postal address :
              <b>Address: XPHV+VHF, Giwana, Haryana 131409 (INDIA)</b>
            </span>
            <p>
              <br />
              You have the right to make a complaint at any time to the
              Information Commissioner’s Office (ICO), the India supervisory
              authority for data protection issues (
              <NavLink to={"http://khweather.netlify.app/"} target="blank">
                khWeather
              </NavLink>
            ...
            <h3 id="id2">2. THE DAYTA WE COLLECT ABOUT YOU</h3>
            <p>
            ...
            <p>Data we collect and store while you are using khWeather APIs:</p>
            <li>
              <b>API usage </b> includes how many API requests and for which API
              products they were made. We do not share this data with
            ...
            <span id="intstylleft">
              ...
              measurements, data format, etc. When you make API requests, we
              also do not collect or store your IP address, user agent and other
              API request parameters.
            </span>
            <p>
              <br />
              Data we collect and store while you are using khWeather website:
            </p>
            <p>
            ...
            <p>
              Data we collect and store when you become an khWeather customer
              (when you subscribe to our services):
            </p>
            <p>
              <b>Identity Data</b> includes first name, last name, username or
              similar identifier and password.
            </p>
            <p>
              <b>Contact Data</b> includes billing address and email address.
            </p>
            <p>
            ...
            <p>
              <b>Marketing and Communications</b> Data includes your preferences
              in receiving marketing from us and our third parties and your
              communication preferences and surveys information.
            </p>
            <p>
            ...
            <p>
              In the course of discharging our contractual obligations to you,
            ...
            <p>
              ...
              with services). In this case, we may have to cancel a product or
              service you have with us but we will notify you if this is the
              case at the time.
            </p>

            <h2 id="id3">3. HOW IS YOUR PERSONAL DATA COLLECTED? </h2>
            <p>
            ...
            <p>
              ...
              this personal data by using server logs and other similar
              technologies.
            </p>
            <p>
              <b>Third parties or publicly available sources.</b> We may receive
            ...
            <li>
              (a) analytics providers such as Google Analytics and Google tech
              manager; and
            </li>
            <li>(b) advertising networks such as HelpDesk; and</li>
            <li>
              (c) Contact, Financial and Transaction Data from providers of
              technical, payment and delivery services
            </li>

            <h3 id="id4">4. HOW WE USE YOUR PERSONAL DATA</h3>
            <p>
            ...
            <p>
              Where it is necessary for our legitimate interests, when we acting
              in pursue of our business purposes and your interests and
            ...
            <p>
              ...
              our or third party direct marketing communications to you via
            ...
            <h3 id="id5">5. DISCLOSURES OF YOUR PERSONAL DATA</h3>
            <p>
            ...
            <li>
              ...
              parts of our business or our assets; or who may be interested in
              buying our business or investing. Alternatively, we may seek to
            ...
            <h3 id="id6">6. INTERNATIONAL TRANSFERS</h3>
            <p>
              We share your personal data within the khWeather Ltd Group. This
              will involve transferring your data outside the European Economic
              Area (EEA).
            </p>
            <p>
              ...
              personal data. These rules are called “binding corporate rules”.
              For further details, see European Commission: Binding corporate
              rules.
            </p>
            <p>
            ...
            <p>
              ...
              six years after they cease being customers for legal purposes.
            </p>
            ...
            <h3 id="id9">9. YOUR LEGAL RIGHTS</h3>
            <p>
            ...
            <h3 id="id10">10. GLOSSARY</h3>
            <p>
              <b>LAWFUL BASIS</b>
            </p>
            <p>
              <b> Legitimate </b>Interest means the interest of our business in
            ...
            <p>
              ...
              it is necessary for the performance of a contract to which you are
            ...
            <p>
              Other companies in the khWeather Ltd Group acting as joint
              controllers who are based in Latvia and USA.
            </p>
            ...
            <p>
              Professional advisers acting as processors including lawyers and
              auditors based in USA who provide banking, legal and accounting
              services.
            </p>
            <p>
            ...
            <p>
              Potential investors who signed non-disclosure and non-compete
              agreements.
            </p>
            <p>
            ...
            <p>
              <b>Request access </b> your personal data (commonly known as a
            ...
            <p>
              ...
              local law. Note, the further retention of the personal data should
              ...
              obligation, for the performance of a task carried out in the
              public interest or in the exercise of official authority vested in
              the controller, on the grounds of public interest in the area of
              public health, for archiving purposes in the public interest,
            ...
            <p>
              <b>Request restriction </b>of processing of your personal data.
